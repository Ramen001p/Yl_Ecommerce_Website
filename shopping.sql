...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 15, 2022 at 02:05 PM
...
(1, 'Bablu ', 'bablu@gmail.com', '9547708474', 'Bm1234@@'),
(2, 'Ramen', 'ramen@gmail.com', '9547708474', 'Ramen@2001'),
(3, 'ppd', 'ppd@gmail.com', '7894562478', 'Ppd@2001');
...
INSERT INTO `categories` (`id`, `Category_Name`, `Category_Image`, `SelectCategory`, `Image_Name`) VALUES
...
--
-- Table structure for table `deliverd_order`
--

CREATE TABLE `deliverd_order` (
  `id` int(100) NOT NULL,
...
--
-- Dumping data for table `deliverd_order`
--

INSERT INTO `deliverd_order` (`id`, `p_id`, `user_id`, `s_id`, `p_img`, `p_name`, `total_price`) VALUES
(1, 4, 13, 2, ' product/men_c41.jpg ', ' HRX  ', ' 1799'),
(2, 12, 14, 2, ' product/women_c51.jpg ', ' Sangria ', ' 1159'),
(3, 12, 13, 2, ' product/women_c51.jpg ', ' Sangria ', ' 1159');
...
INSERT INTO `review_table` (`review_id`, `product_id`, `user_id`, `user_name`, `user_rating`, `user_review`) VALUES
(29, 4, 13, 'Ramen Ghosh', 'VeryGood', 'ok'),
(30, 12, 13, 'Ramen Ghosh', 'Good', 'Nice Dress');
...
INSERT INTO `users` (`id`, `username`, `email`, `phone`, `password`, `billing_name`, `Address`, `City`, `Pin`, `State`) VALUES
(13, 'Ramen Ghosh', 'ramenghosh002@gmail.com', '7001837247', 'Ramen@2001', 'Ramen Ghosh', 'khirpai,halderdighi,wordno.2', 'Khirpai', 721232, 'West Bengal'),
(14, 'Bablu Murmu', 'bm002@gmail.com', '8250305270', 'Ramen@2001', 'Bablu Murmu', 'haldia', 'haldia', 7000215, 'east bengal'),
(18, 'prem kumar patra', 'prempatra2002@gmail.com', '7895787867', 'Prem@2001', 'prem kumar patra', '', '', 0, '');
...
INSERT INTO `user_order` (`id`, `s_id`, `User_id`, `product_id`, `name`, `price`, `image`, `quantity`) VALUES
(132, 3, 13, 1, 'Anouk', '1399\r\n', 'product/men_c11.jpg', 1);
...
--
-- Indexes for table `deliverd_order`
--
ALTER TABLE `deliverd_order`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `deliverd_order`
--
ALTER TABLE `deliverd_order`
