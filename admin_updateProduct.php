...
<h2 align="center">Update Your Product</h2><br><br>
  <form  method="POST" enctype="multipart/form-data">
    <div class="row">
      ...
      <div class="col-75">
        <input type="text" id="Pname" name="Pname" placeholder="Enter Your Product Name">
      </div>
    </div>
    ...
    <div class="row">
      ...
      <div class="col-75">
        <input type="text" id="Description" name="Description" placeholder="Enter Short Description of Your Product">
      </div>
    </div>
    ...
    <div class="row">
      ...
      <div class="col-75">
        <input type="text" id="Details" name="Details" placeholder="Enter Details of Your Product">
      </div>
    </div>
     ...
     <div class="row">
      ...
      <div class="col-75">
        <input type="text" id="sf" name="sf" placeholder="Enter Size & Fit of Your Product">
      </div>
    </div>
  ...
  <div class="row">
      ...
      <div class="col-75">
        <input type="text" id="mc" name="mc" placeholder="Enter Material & Care of Your Product">
      </div>
    </div>
    ...
    <div class="row">
      ...
      <div class="col-75">
        <input type="text" id="Price" name="Price" placeholder="Enter Price of Your Product">
      </div>
    </div>
    ...
    <div class="row">
      ...
      <div class="col-75">
        <input type="text" id="Offprice" name="Offprice" placeholder="Enter Off-Price on Your Product">
      </div>
    </div>
    ...
    <div class="row">
      ...
      <div class="col-75">
        <input type="text" id="Discount" name="Discount" placeholder="Enter Discount on Your Product">
      </div>
    </div>
    ...
    <div class="row">
      ...
      <div class="col-75">
        <input type="text" id="qnty" name="qnty" placeholder="Enter Available Quantity Of Your Product">
      </div>
    </div>
