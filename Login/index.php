...
<body>
  ...
  <div class="container">
    ...
    <div class="cover">
      <div class="front">
        <img  src="customer.jpg" alt="Front Image">
        <div class="text">
          <span class="text-1">Happiness<br>is not<br>in money<br>but in<br>shopping</span>
          <span class="text-2"><br>Let's get connected</span>
        </div>
      </div>
      <div class="back">
        <img class="backImg" src="customer.jpg" alt="Back Image">
        <div class="text">
          <span class="text-1">Happiness<br>is not<br>in money<br>but in<br>shopping</span>
